...
module.exports = require("../lib/utils/aria-dialog");
...
var external_lib_locale_ = __webpack_require__(19);

// EXTERNAL MODULE: external "../lib/utils/aria-dialog"
    ...
    validate: function validate() {
      if (this.$type === 'prompt') {
        ...
        if (inputPattern && !inputPattern.test(this.inputValue || '')) {
          this.editorErrorMessage = this.inputErrorMessage || Object(external_lib_locale_["t"])('el.messagebox.error');
